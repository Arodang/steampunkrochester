(function () {
    ...
    var censusDataController = app.controller("censusDataController", ["$scope", "censusDataService", function ($scope, censusDataService) {

        $scope.persons = censusDataService;
        $scope.showForm = true;
